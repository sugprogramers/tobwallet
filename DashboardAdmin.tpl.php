...
<?php 
$ctienda = "";
if($this->selectTienda!= 0)
 $ctienda = " and IdSucursal = {$this->selectTienda} " ;  
 
$condicion = " and ( YEAR(FechaVenta)>={$this->selectYearIni} and YEAR(FechaVenta)<= {$this->selectYearFin} ) ";
//ingreso
$query1 = "select YEAR(FechaVenta) as year, MONTH(FechaVenta) as month , SUM(TotalVenta) as suma from venta where EstadoVenta >= 1 $condicion  $ctienda GROUP BY YEAR(FechaVenta), MONTH(FechaVenta)";  
//ventas
$query2 = "select YEAR(FechaVenta) as year, MONTH(FechaVenta) as month , Count(IdVenta) as suma from venta where EstadoVenta >= 1 $condicion  $ctienda GROUP BY YEAR(FechaVenta), MONTH(FechaVenta)";  
...
//ingreso
$query1 = "select YEAR(FechaVenta) as year, MONTH(FechaVenta) as month ,DAY(FechaVenta) as day , SUM(TotalVenta) as suma from venta where EstadoVenta >= 1 $condicion  $ctienda GROUP BY YEAR(FechaVenta), MONTH(FechaVenta),DAY(FechaVenta)";  
//ventas
$query2 = "select YEAR(FechaVenta) as year, MONTH(FechaVenta) as month ,DAY(FechaVenta) as day , Count(IdVenta) as suma from venta where EstadoVenta >= 1 $condicion  $ctienda GROUP BY YEAR(FechaVenta), MONTH(FechaVenta),DAY(FechaVenta)";  
   ...
   <div class="widget-content padding-30 bg-cyan-800">
     ...
     <div class="pull-right vertical-align-middle">       
      <?php  $this->lstYear->Render(); ?> 
       ...
       <div class="pull-right vertical-align-middle" style="margin-right:  2px;">       
