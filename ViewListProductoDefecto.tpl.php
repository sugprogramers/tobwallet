    ...
    <div class="page-content container-fluid">
        ...
        <div class="panel">
            <header class="panel-heading">
                <h3 class="panel-title">Ver Productos defectos</h3>
            </header>
                    ...
                    <div id="Found1" style="display:none;" class="vertical-align text-center">
                        <div class="page-content vertical-align-middle">
                            <header>
                                ...
                                <p style="font-size: 22px;color: #848484;">No se encontraron Productos por defecto
                                    registrados</p>
                            </header>
                            <p class="error-advise animation-slide-left" style="font-size: 12px;">Usted debe registrar
                                un nuevo Producto por defecto</p>
                            <br>
                        </div>
                    </div>
                    ...
                    <div id="Found2" style="display:none;" class="example-wrap">
                        ...
                        <div class="example">
                            <div class="table-responsive">
                                <?php $this->dtgProductodefectos->Render(); ?>
                            </div>
