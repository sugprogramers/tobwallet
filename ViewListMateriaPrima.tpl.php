    ...
    <div class="page-content container-fluid">
        ...
        <div class="panel">
            <header class="panel-heading">
                <h3 class="panel-title">Ver Materias Primas</h3>
            </header>
            <div class="panel-body" style="min-height:260px;">
                    ...
                    <div id="Found1" style="display:none;" class="vertical-align text-center" >
                        <div class="page-content vertical-align-middle">
                            <header>
                                ...
                                <p   style="font-size: 22px;color: #848484;">No se encontraron materias primas registradas</p>
                            </header>
                            <p class="error-advise animation-slide-left" style="font-size: 12px;">Usted debe registrar un nueva Materia Prima.</p>
                            <br>
                        </div>
                    </div>
                    ...
                    <div id="Found2" style="display:none;"  class="example-wrap">
                        ...
                        <div class="example example-box hola1">
                            <div class="row">
                                <div class="col-sm-5 form-group">
                                    <?php $this->txtNombreMateria->Render(); ?>
                                </div>
                        ...
                        <div class="example">
                            <div class="table-responsive">
                                <?php $this->dtgMateriaprimas->Render(); ?>
                            </div>
                ...
                <div class="site-action" > 
                    ...
                    <?php $this->btnNewMateriaprima->Render(); ?> </div>
...
<?php $this->dlgDialogEditMateriaPrima->Render(); ?>
