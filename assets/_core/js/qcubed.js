...
///////////////////////////////////////////////////
	var qcubed = {
		...
		postAjax: function(strForm, strControl, strEvent, strParameter, strWaitIconControlId, asyncOn) {
			...
			if (strWaitIconControlId) {
				...
				{  this.objAjaxWaitIcon.style.display = 'inline';
                        ...
                        if (typeof asyncOn === 'undefined') { asyncOn = true; }else asyncOn = false;
                        //console.log('option  ' + asyncOn);
