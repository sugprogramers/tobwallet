    ...
    handleArrangement: function() {
      $('#arrangement-grid').on('click', function() {
        ...
        if ($this.hasClass('active')) {
          ...
          $('.media-list>ul>div>div>li').removeClass('animation-fade').addClass('animation-scale-up');
      ...
      $('#arrangement-list').on('click', function() {
        ...
        if ($this.hasClass('active')) {
          ...
          $('.media-list>ul>div>div>li').removeClass('animation-scale-up').addClass('animation-fade');
        }
      });
    },
