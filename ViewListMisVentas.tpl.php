    ...
    <div class="page-content container-fluid">
        ...
        <div class="panel">
            <header class="panel-heading">
                <h3 class="panel-title">Ver Mis Ventas</h3>
            </header>
                ...
                <div class="row">
                    <div id="Found1" style="display:none;" class="vertical-align text-center" >
                        <div class="page-content vertical-align-middle">
                            <header>
                                <div class="animation-slide-top" style="font-size: 65px;margin-right:0px;padding: 0px;color:#ccc;"><i class="icon fa-shopping-cart" aria-hidden="true"></i></div>
                                <p   style="font-size: 22px;color: #848484;">No se encontraron sus Ventas</p>
                            </header>
                            <p class="error-advise animation-slide-left" style="font-size: 12px;">Usted debe crear nueva venta.</p>
                            <br>
                        </div>
                    </div>
                    <!-- Example Basic Sort -->
