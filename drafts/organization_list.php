<?php
	...
	require(__FORMBASE_CLASSES__ . '/OrganizationListFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class OrganizationListForm extends OrganizationListFormBase {
...
//		protected function Form_Create() {}
	...
	// organization_list.tpl.php as the included HTML template file
	OrganizationListForm::Run('OrganizationListForm');
?>