<?php
	 ...
	 * list a collection of Organizationtype objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this OrganizationtypeListPanelBase
	 * class.
	 *
	 ...
	 *
	 */
	class OrganizationtypeListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list Organizationtypes
		/**
		 * @var OrganizationtypeDataGrid
		 */
		public $dtgOrganizationtypes;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = __DOCROOT__ . __PANEL_DRAFTS__ . '/OrganizationtypeListPanel.tpl.php';
			...
			$this->dtgOrganizationtypes->ItemsPerPage = 8;
			...
			$this->dtgOrganizationtypes->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('Organizationtype');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new OrganizationtypeEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new OrganizationtypeEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
