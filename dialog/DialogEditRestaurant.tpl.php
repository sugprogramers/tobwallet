                        ...
                        <div class="tab-pane" id="exampleTabsLeftFour" role="tabpanel">
                            <div class="form-group row">
                                <div class="col-sm-12" style="height: 250px">
                                    <img src="<?php _p(__VIRTUAL_DIRECTORY__ . __SUBDIRECTORY__ . '/upload/' . (( $_CONTROL->mctRestaurant->objRestaurant->Logo == null) ? "empty.jpg" : $_CONTROL->mctRestaurant->objRestaurant->Logo )) ?>" style="max-height: 100%;max-width: 100%" />
                                </div>
                            </div>
                        </div>
                    <?php } ?>
