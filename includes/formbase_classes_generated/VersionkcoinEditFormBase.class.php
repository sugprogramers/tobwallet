<?php
	 ...
	 */
	abstract class VersionkcoinEditFormBase extends QForm {
		// Local instance of the VersionkcoinMetaControl
		/**
		 * @var VersionkcoinMetaControlGen mctVersionkcoin
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the VersionkcoinMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctVersionkcoin = VersionkcoinMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/versionkcoin_list.php');
		}
	}
?>
