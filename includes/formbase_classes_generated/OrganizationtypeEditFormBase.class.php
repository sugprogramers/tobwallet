<?php
	 ...
	 */
	abstract class OrganizationtypeEditFormBase extends QForm {
		// Local instance of the OrganizationtypeMetaControl
		/**
		 * @var OrganizationtypeMetaControlGen mctOrganizationtype
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the OrganizationtypeMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctOrganizationtype = OrganizationtypeMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/organizationtype_list.php');
		}
	}
?>
