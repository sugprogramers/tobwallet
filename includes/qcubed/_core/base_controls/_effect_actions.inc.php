...
class QJQTogglefadeInAction extends QJQAction {
	protected $strOptions = null;
	protected $strSpeed = null;
	...
	public function RenderScript(QControl $objControl) {
		return sprintf('$j("#%s").fadeTo("slow",0.7);', $this->strControlId, $this->strMethod, $this->strOptions, $this->strSpeed);
                
                /*$j("#%s").toggle().fadeIn("slow");
                 $j("#%s").fadeTo("slow",0.8);
                http://www.lewebmonster.com/metodos-para-realizar-animaciones-estandar-con-la-libreria-jquery-parte-2/
                 */
	}
}
