<?php
	 ...
	 * @property string $Text is the contents of the textbox, itself
         * @property string $Placeholder is the placeholder of the textbox, itself
		...
		protected function GetControlHtml() {
			...
			switch ($this->strTextMode) {
				case QTextMode::MultiLine:
					$strToReturn = sprintf('<textarea  placeholder="'.$this->strPlaceholder.'"  name="%s" id="%s" %s%s>' . $this->strFormat . '</textarea>',
						$this->strControlId,
						$this->strControlId,
						$this->GetAttributes(),
						$strStyle,
				...
				case QTextMode::Password:
					$strToReturn = sprintf('<input placeholder="'.$this->strPlaceholder.'" type="password" name="%s" id="%s" value="' . $this->strFormat . '" %s%s />',
						$this->strControlId,
						$this->strControlId,
						QApplication::HtmlEntities($this->strText),
						$this->GetAttributes(),
				...
				default:
					$strToReturn = sprintf('<input placeholder="'.$this->strPlaceholder.'" type="text" name="%s" id="%s" value="' . $this->strFormat . '" %s%s />',
						$this->strControlId,
						$this->strControlId,
						QApplication::HtmlEntities($this->strText),
						$this->GetAttributes(),
