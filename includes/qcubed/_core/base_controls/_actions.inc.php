		...
		public function RenderScript(QControl $objControl) {
			...
			if ((gettype($this->objWaitIconControl) == 'string') && ($this->objWaitIconControl == 'default')) {
				...
				$strWaitIconControlId = $this->objWaitIconControl->ControlId;
                        ...
                        $script= '';
                        /*if(trim($strWaitIconControlId)!='')
                        {
                           $script= '$j("#'.$strWaitIconControlId.'").fadeTo(400,0.3,function(){  $j("#'.$strWaitIconControlId.'").fadeTo(400,1);});'; 
                        }*/
                        
                        //$script=$script.'$j("#content1").fadeTo("slow",0.5,function(){  $j("#content1").fadeTo("slow",1);});';
                        
                        
			return sprintf( $script. "qc.pA('%s', '%s', '%s', '%s', '%s'); ",
