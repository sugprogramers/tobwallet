	...
	class QFlot extends QControl {
		...
		public function MakeTrend($objSourceSeries) {
			...
			foreach($temp as $X => $Y) {
				...
				$objTrendSeries->AddDataPoint((string)$XValue.'h',(string)$YValue);
		 	}
		...
		public function Render($blnDisplayOutput = true) {
			...
			try {
				...
				if($this->blnDisplayVariables){
					$this->strHtmlBefore.= "<br/><div id=\"" . $this->strControlId . "_variables\">";
					if($this->strVariablesTitle)
						$this->strHtmlBefore.= $this->strVariablesTitle.'<br/><br/>';
			...
			$strJS .= "\n}";
		 	$strJS.= "
			    ...
			    if($this->blnDisplayVariables) {
			    	...
			    	$strJS.=" jQuery.each( " . $this->strControlId . "_datasets, function(key, val) {
				    data.push(" . $this->strControlId . "_datasets[key]);
