...
class ViewListProductoTiendaForm extends QForm
{
    ...
    public function actionFilter_Click($strFormId, $strControlId, $strParameter)
    {
        ...
        if ($this->lstTienda->SelectedValue != 0) {
            $searchTipo = QQ::Equal(QQN::Productosucursal()->IdSucursal, $this->lstTienda->SelectedValue);
        } else {
            $searchTipo = QQ::All();
        }
...
ViewListProductoTiendaForm::Run('ViewListProductoTiendaForm');
?>