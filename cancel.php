    ...
    <body class="layout-full"> <!-- page-login-v3  -->
        ...
        <div class="page animsition vertical-align text-center" data-animsition-in="fade-in"
            ...
            <div class="page-content vertical-align-middle">
                <a href="<?php _p(__VIRTUAL_DIRECTORY__ . __SUBDIRECTORY__); ?>/mining">   <img class="brand-img" src="<?php _p(__VIRTUAL_DIRECTORY__ . __SUBDIRECTORY__); ?>/template/assets/images/logo-blue%402x.png" alt="..."> </a>
                <br> <br> <br>
                <div role="alert" class="alert dark alert-danger alert-dismissible">
                    ...
                    <h4>Cancel Paypal</h4>
                    <p>
                        This order was not successful. Please try again
                    </p>
                    <p class="margin-top-15">
                        <a href="<?php echo __VIRTUAL_DIRECTORY__ . __SUBDIRECTORY__ . '/mining'; ?>" class="btn btn-primary btn-inverse btn-outline" >Back </a>
