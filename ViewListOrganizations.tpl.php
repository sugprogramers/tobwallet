...
<div class="page">
    <div class="page-header">
        <h1 class="page-title"> <i class="site-menu-icon wb-users" aria-hidden="true"></i> Organizations</h1>
    </div>
                    ...
                    <div id="Found1" style="display:none;" class="vertical-align text-center" >
                        <div class="page-content vertical-align-middle">
                            <header>
                                ...
                                <p   style="font-size: 22px;color: #848484;">No registered organizations were found.</p>
                            </header>
                            <p class="error-advise animation-slide-left" style="font-size: 12px;">You must register a new organization.</p>
                            <br>
                        </div> 
                    </div>
